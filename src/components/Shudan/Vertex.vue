<template>
    ...
    >
        ...
        <div key="stone" class="shudan-stone" :style="absoluteStyle(2)">
            <div key="shadow" v-if="!!sign" class="shudan-shadow" :style="absoluteStyle()"></div>
            <div
                key="inner"
                v-if="!!sign"
                :class="['shudan-inner', 'shudan-stone-image', `shudan-random_${random}`, `shudan-sign_${sign}`]"
                :style="absoluteStyle()"
            >{{ sign }}</div>
            <div
                key="marker"
        ...
        <div key="paint" v-if="!!paint" class="shudan-paint" :style="absoluteStyle(3)"></div>
        <div key="selection" v-if="!!selected" class="shudan-selection" :style="absoluteStyle(4)"></div>

        <div key="heat" class="shudan-heat" :style="absoluteStyle(5)"></div>
        <div
            key="heatlabel"
            v-if="!!heat"
